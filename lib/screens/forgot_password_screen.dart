  ...
  void _sendResetLink() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        ...
        content: Text(
          "Error: Account not found. Please verify your email.", 
          style: TextStyle(fontWeight: FontWeight.w600, color: Colors.white)
        ),
      ));
    }
      ...
      body: Center(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              // Clean Clinical Icon
              const Icon(Icons.lock_open_rounded, size: 64, color: AppTheme.primary)
                  .animate()
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: const InputDecoration(
                          ...
                          hintStyle: TextStyle(color: AppTheme.neutral, fontSize: 14),
                        ),
                      ),
